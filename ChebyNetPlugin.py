...
def get_parameters():
    ...
    model_save_dir = os.path.join('plugins/ChebyNet/model/save', dataset)
...
def prepare_model(device, n_feat, n_hid, n_class, enable_bias, Ko, Kl, droprate, \
...
class ChebyNetPlugin:
   ...
   def output(self, outputfile):
    ...
    model, loss, early_stopping, optimizer, scheduler = prepare_model(device, n_feat, n_hid, n_class, enable_bias, Ko, Kl, droprate, patience, model_save_path, opt, lr, weight_decay)
